...
DB_PORT="3306"
DB_USER="root"
DB_PASSWORD="teevee888"
DB_NAME="huutonet"

DB_URL = f"mysql+mysqlconnector://{DB_USER}:{DB_PASSWORD}@{DB_HOSTNAME}:{DB_PORT}/{DB_NAME}"
...
db = session()
select_query = select(Item).where(Item.item_id == 4)
print(type(select_query))
print(select_query)
item = db.execute(select_query)
print(item)
